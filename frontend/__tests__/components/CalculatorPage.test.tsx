...
jest.mock('@heroui/react', () => ({
  ...
  Radio: ({ children, value, onValueChange, groupId }: any) =>
    React.createElement(
      'label',
      null,
...
test("Affichage de l'écran résultat après soumission complète", async () => {
  ...
  fireEvent.click(allRadios[0], { target: { value: '1' } })
  fireEvent.click(allRadios[2], { target: { value: '1' } })
